...
public class OwnerFilter extends OncePerRequestFilter {
    ...
    private final CustomOwnerService userDetailsService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            CustomOwner userDetails = userDetailsService.loadUserByUsername(username);

            String userRole = ownerRepository.findByUsername(username).get().getRole().toString();
